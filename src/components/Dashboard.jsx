    ...
    <div className="dashboard-container">
      ...
      <div className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
        ...
        <nav className="sidebar-nav">
          <button onClick={() => { navigate('/add-expense'); setSidebarOpen(false); }} className="sidebar-link">
            <FaPlus /> Add Expense
          </button>
          <button onClick={() => { navigate('/expense-list'); setSidebarOpen(false); }} className="sidebar-link">
            <FaList /> Expense List
          </button>
          <button onClick={() => navigate('/budget')} className="sidebar-link">
            <FaChartLine /> Budget
          </button>
          <button onClick={() => { navigate('/charts'); setSidebarOpen(false); }} className="sidebar-link">
            <FaChartPie /> Charts
          </button>
